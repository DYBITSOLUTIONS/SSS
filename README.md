...
vivo y lo que asoma en él. Cada sección (`#juego`, `#juegas`, `#bestiario`,
`#noche`, `#mareas`, `#jugar`) es una **pantalla** que se abre encima del agua,
de una en una, con su *volver al mar* arriba y su *siguiente* al pie.
...
| **Isla y roca** | `assets/mar` | Asoman en el horizonte y se borran con la niebla. Nunca se acercan. |
...
- La fase se dibuja en un **lienzo aparte** y se pega ya recortada. Dos razones:
  la mordida se hace con `destination-out`, que en el lienzo grande abriría un
  agujero al negro del fondo (el bug del 13 sep), y así la luna entera puede
  entrar y salir con alfa durante el viraje. La sombra es media luna + una
  elipse: si la luz es menos de media, la elipse **come** sombra; si es más
  (gibosa), **devuelve** luz.
